<div class="dlm_mb_shop_product_information">
    ...
    <p class="dlm_shop_field_row">
        <label class="dlm_shop_field_label"><?php printf( __( 'Price (%s)', 'download-monitor' ), \WPChill\DownloadMonitor\Shop\Services\Services::get()->service( 'currency' )->get_currency_symbol() ); ?></label>
    ...
    <p class="dlm_shop_field_row">
        <label class="dlm_shop_field_label"><?php printf( __( 'Downloads', 'download-monitor' ), \WPChill\DownloadMonitor\Shop\Services\Services::get()->service( 'currency' )->get_currency_symbol() ); ?></label>
        <span class="dlm_shop_field_input">
    ...
    <p>
        ...
        <select name="_dlm_tax_class">
			<?php
			$classes = \WPChill\DownloadMonitor\Shop\Services\Services::get()->service( 'tax_class_manager' )->get_tax_rates();
			if ( count( $classes ) > 0 ) {
