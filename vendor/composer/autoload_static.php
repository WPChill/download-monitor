...
class ComposerStaticInit80ce4473100edd20fd6c17775a76ce9a
{
    ...
    public static $classMap = array (
        ...
        'DLM_Plugin_Status' => __DIR__ . '/../..' . '/src/Admin/class-dlm-templates-actions.php',
        ...
        'FS_Admin_Menu_Manager' => __DIR__ . '/../..' . '/includes/submodules/freemius/includes/managers/class-fs-admin-menu-manager.php',
        'FS_Admin_Notice_Manager' => __DIR__ . '/../..' . '/includes/submodules/freemius/includes/managers/class-fs-admin-notice-manager.php',
        'FS_Admin_Notices' => __DIR__ . '/../..' . '/includes/submodules/freemius/includes/class-fs-admin-notices.php',
        'FS_Affiliate' => __DIR__ . '/../..' . '/includes/submodules/freemius/includes/entities/class-fs-affiliate.php',
        'FS_AffiliateTerms' => __DIR__ . '/../..' . '/includes/submodules/freemius/includes/entities/class-fs-affiliate-terms.php',
        'FS_Api' => __DIR__ . '/../..' . '/includes/submodules/freemius/includes/class-fs-api.php',
        'FS_Billing' => __DIR__ . '/../..' . '/includes/submodules/freemius/includes/entities/class-fs-billing.php',
        'FS_Cache_Manager' => __DIR__ . '/../..' . '/includes/submodules/freemius/includes/managers/class-fs-cache-manager.php',
        'FS_Clone_Manager' => __DIR__ . '/../..' . '/includes/submodules/freemius/includes/managers/class-fs-clone-manager.php',
        'FS_Customizer_Support_Section' => __DIR__ . '/../..' . '/includes/submodules/freemius/includes/customizer/class-fs-customizer-support-section.php',
        'FS_Customizer_Upsell_Control' => __DIR__ . '/../..' . '/includes/submodules/freemius/includes/customizer/class-fs-customizer-upsell-control.php',
        'FS_Entity' => __DIR__ . '/../..' . '/includes/submodules/freemius/includes/entities/class-fs-entity.php',
        'FS_GDPR_Manager' => __DIR__ . '/../..' . '/includes/submodules/freemius/includes/managers/class-fs-gdpr-manager.php',
        'FS_Key_Value_Storage' => __DIR__ . '/../..' . '/includes/submodules/freemius/includes/managers/class-fs-key-value-storage.php',
        'FS_License_Manager' => __DIR__ . '/../..' . '/includes/submodules/freemius/includes/managers/class-fs-license-manager.php',
        'FS_Lock' => __DIR__ . '/../..' . '/includes/submodules/freemius/includes/class-fs-lock.php',
        'FS_Logger' => __DIR__ . '/../..' . '/includes/submodules/freemius/includes/class-fs-logger.php',
        'FS_Option_Manager' => __DIR__ . '/../..' . '/includes/submodules/freemius/includes/managers/class-fs-option-manager.php',
        'FS_Options' => __DIR__ . '/../..' . '/includes/submodules/freemius/includes/class-fs-options.php',
        'FS_Payment' => __DIR__ . '/../..' . '/includes/submodules/freemius/includes/entities/class-fs-payment.php',
        'FS_Permission_Manager' => __DIR__ . '/../..' . '/includes/submodules/freemius/includes/managers/class-fs-permission-manager.php',
        'FS_Plan_Manager' => __DIR__ . '/../..' . '/includes/submodules/freemius/includes/managers/class-fs-plan-manager.php',
        'FS_Plugin' => __DIR__ . '/../..' . '/includes/submodules/freemius/includes/entities/class-fs-plugin.php',
        'FS_Plugin_Info' => __DIR__ . '/../..' . '/includes/submodules/freemius/includes/entities/class-fs-plugin-info.php',
        'FS_Plugin_Info_Dialog' => __DIR__ . '/../..' . '/includes/submodules/freemius/includes/fs-plugin-info-dialog.php',
        'FS_Plugin_License' => __DIR__ . '/../..' . '/includes/submodules/freemius/includes/entities/class-fs-plugin-license.php',
        'FS_Plugin_Manager' => __DIR__ . '/../..' . '/includes/submodules/freemius/includes/managers/class-fs-plugin-manager.php',
        'FS_Plugin_Plan' => __DIR__ . '/../..' . '/includes/submodules/freemius/includes/entities/class-fs-plugin-plan.php',
        'FS_Plugin_Tag' => __DIR__ . '/../..' . '/includes/submodules/freemius/includes/entities/class-fs-plugin-tag.php',
        'FS_Plugin_Updater' => __DIR__ . '/../..' . '/includes/submodules/freemius/includes/class-fs-plugin-updater.php',
        'FS_Pricing' => __DIR__ . '/../..' . '/includes/submodules/freemius/includes/entities/class-fs-pricing.php',
        'FS_Scope_Entity' => __DIR__ . '/../..' . '/includes/submodules/freemius/includes/entities/class-fs-scope-entity.php',
        'FS_Security' => __DIR__ . '/../..' . '/includes/submodules/freemius/includes/class-fs-security.php',
        'FS_Site' => __DIR__ . '/../..' . '/includes/submodules/freemius/includes/entities/class-fs-site.php',
        'FS_Storage' => __DIR__ . '/../..' . '/includes/submodules/freemius/includes/class-fs-storage.php',
        'FS_Subscription' => __DIR__ . '/../..' . '/includes/submodules/freemius/includes/entities/class-fs-subscription.php',
        'FS_User' => __DIR__ . '/../..' . '/includes/submodules/freemius/includes/entities/class-fs-user.php',
        'FS_User_Lock' => __DIR__ . '/../..' . '/includes/submodules/freemius/includes/class-fs-user-lock.php',
        'Freemius' => __DIR__ . '/../..' . '/includes/submodules/freemius/includes/class-freemius.php',
        'Freemius_Abstract' => __DIR__ . '/../..' . '/includes/submodules/freemius/includes/class-freemius-abstract.php',
        'Freemius_Api_Base' => __DIR__ . '/../..' . '/includes/submodules/freemius/includes/sdk/FreemiusBase.php',
        'Freemius_Api_WordPress' => __DIR__ . '/../..' . '/includes/submodules/freemius/includes/sdk/FreemiusWordPress.php',
        'Freemius_ArgumentNotExistException' => __DIR__ . '/../..' . '/includes/submodules/freemius/includes/sdk/Exceptions/ArgumentNotExistException.php',
        'Freemius_Debug_Bar_Panel' => __DIR__ . '/../..' . '/includes/submodules/freemius/includes/debug/class-fs-debug-bar-panel.php',
        'Freemius_EmptyArgumentException' => __DIR__ . '/../..' . '/includes/submodules/freemius/includes/sdk/Exceptions/EmptyArgumentException.php',
        'Freemius_Exception' => __DIR__ . '/../..' . '/includes/submodules/freemius/includes/sdk/Exceptions/Exception.php',
        'Freemius_InvalidArgumentException' => __DIR__ . '/../..' . '/includes/submodules/freemius/includes/sdk/Exceptions/InvalidArgumentException.php',
        'Freemius_OAuthException' => __DIR__ . '/../..' . '/includes/submodules/freemius/includes/sdk/Exceptions/OAuthException.php',
