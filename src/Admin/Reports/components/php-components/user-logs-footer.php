...
<div class="user-downloads-block-navigation">
	<div class='downloads-block-navigation'>
		<?php esc_html_e( 'Page:', 'download-monitor' ) ?><input type="number" value="1" class="dlm-reports-current-page"> <?php esc_html_e( 'of', 'download-monitor' ) ?> <span class="dlm-reports-total-pages">1</span>
