...
if ( ! class_exists( 'DLM_DB_Upgrader' ) ) {
	...
	class DLM_DB_Upgrader {
		...
		public function init(){
			...
			if ( null !== $cat_col_type && ! $cat_col_type ) {
				...
				wp_add_inline_script(
					'dlm-log-db-upgrade',
					'dlm_upgraderColumn =' . wp_json_encode(
						array(
							'nonce'                     => wp_create_nonce( 'dlm-ajax-nonce' ),
							'upgrade_download_category' => esc_html__( 'Update started, please wait. Don\'t close or exit this page. it will reload automatically when it\'s finished.', 'download-monitor' )
						)
					),
					'before' );
				// Add notice for users to update the DB for download_log table to alter download_category column.
				add_action( 'admin_notices', array( $this, 'add_db_download_category_notice' ), 8 );
			}

			// Don't do anything if we don't need to or if upgrader already done from below 4.6.x.
			if ( ! self::do_upgrade() ) {
				return;
			}
		...
		/**
		 * Add the DB Upgrader notice to update download_category column.
		 *
		 * @since 4.8.0
		 */
		public function add_db_download_category_notice() {
			?>
			<div class="dlm-upgrade-db-notice notice">
				<div class="dlm-yellow-band-notice">
				...
				<div class="inside">
					<div class="main">
						<img class="dlm-notice-logo" src="data:image/png;base64,">
						<h4><?php echo wp_kses_post( __('Hello there! We made some changes on how Download Monitor\'s data is structured. Please make a backup of your database and click the upgrade button', 'download-monitor' ) ); ?></h4>
						<button id="dlm-upgrade-download_category" class="button button-primary">
							<?php
								esc_html_e( 'Upgrade', 'download-monitor' );
							?>
						</button>
