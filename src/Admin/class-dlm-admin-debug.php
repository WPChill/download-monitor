		...
		<div class="dlm-upsells-carousel-wrapper">
			<div class="dlm-upsells-carousel">
				<div class="dlm-upsell dlm-upsell-item">
					<p class="dlm-upsell-description"><?php echo esc_html__( 'Export the download and send it to Download Monitor\'s support team so that we can debug your problem much easier.', 'download-monitor' ); ?></p>
					<p>
						<a href="<?php echo esc_url( add_query_arg( array(
								'dlm_single_download' => absint( get_the_ID() ),
						) ) ); ?>"
						   class="button"><?php esc_html_e( 'Export download', 'download-monitor' ) ?></a>

					</p>
					<?php do_action('dlm_debug_metabox_content'); ?>
				</div>
			</div>
		</div>
		<?php
