...
namespace Never5\DownloadMonitor\Shop\Dependencies\PayPal\Common;

use Never5\DownloadMonitor\Shop\Dependencies\PayPal\Rest\ApiContext;
use Never5\DownloadMonitor\Shop\Dependencies\PayPal\Rest\IResource;
 ...
 * @package Never5\DownloadMonitor\Shop\Dependencies\PayPal\Common
 */
class PayPalResourceModel extends PayPalModel implements IResource
{
     ...
     */
    protected static function executeCall($url, $method, $payLoad, $headers = array(), $apiContext = null, $restCall = null, $handlers = array('Never5\DownloadMonitor\Shop\Dependencies\PayPal\Handler\RestHandler'))
    {
