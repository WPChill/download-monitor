...
use Never5\DownloadMonitor\Shop\Dependencies\PayPal\Auth\OAuthTokenCredential;
use Never5\DownloadMonitor\Shop\Dependencies\PayPal\Common\PayPalUserAgent;
use Never5\DownloadMonitor\Shop\Dependencies\PayPal\Core\PayPalConstants;
use Never5\DownloadMonitor\Shop\Dependencies\PayPal\Core\PayPalCredentialManager;
...
use Never5\DownloadMonitor\Shop\Dependencies\PayPal\Exception\PayPalInvalidCredentialException;
use Never5\DownloadMonitor\Shop\Dependencies\PayPal\Exception\PayPalMissingCredentialException;
...
class RestHandler implements IPayPalHandler
{
     ...
     *
     * @return string
     * @throws \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Exception\PayPalConfigurationException
     */
