...
use Never5\DownloadMonitor\Shop\Dependencies\PayPal\Core\PayPalConstants;
 ...
 * @property \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\Payer payer
 * @property \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\Transaction[] transactions
 * @property string state
 * @property string experience_profile_id
 * @property string note_to_payer
 * @property \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\Payee $payee
 * @property \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\RedirectUrls redirect_urls
...
class Payment extends PayPalResourceModel
{
     ...
     *
     * @param \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\Payer $payer
     * 
     * @return $this
     */
     ...
     * Source of the funds for this payment represented by a PayPal account or a direct credit card.
     *
     * @return \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\Payer
     */
     ...
     * @param \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\PotentialPayerInfo $potential_payer_info
     * 
     * @return $this
     */
     ...
     * Information that the merchant knows about the payer.  This information is not definitive and only serves as a hint to the UI or any pre-processing logic.
     * @deprecated Not publicly available
     * @return \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\PotentialPayerInfo
     */
     ...
     * @param \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\Payee $payee
     * 
     * @return $this
     */
    ...
    /**
     * Receiver of funds for this payment.
     * @return \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\Payee
     */
     ...
     *
     * @param \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\Transaction[] $transactions
     * 
     * @return $this
     */
     ...
     * Transactional details including the amount and item details.
     *
     * @return \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\Transaction[]
     */
     ...
     *
     * @param \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\Transaction $transaction
     * @return $this
     */
     ...
     * @deprecated Not publicly available
     * @param \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\Error[] $failed_transactions
     * 
     * @return $this
     */
     ...
     * Applicable for advanced payments like multi seller payment (MSP) to support partial failures
     * @deprecated Not publicly available
     * @return \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\Error[]
     */
     ...
     * @deprecated Not publicly available
     * @param \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\Error $error
     * @return $this
     */
     ...
     * @deprecated Not publicly available
     * @param \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\CreditFinancingOffered $credit_financing_offered
     * 
     * @return $this
     */
     ...
     * Credit financing offered to payer on PayPal side. Returned in payment after payer opts-in
     * @deprecated Not publicly available
     * @return \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\CreditFinancingOffered
     */
     ...
     * @deprecated Not publicly available
     * @param \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\PaymentInstruction $payment_instruction
     * 
     * @return $this
     */
     ...
     * Instructions for the payer to complete this payment.
     * @deprecated Not publicly available
     * @return \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\PaymentInstruction
     */
     ...
     *
     * @param \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\RedirectUrls $redirect_urls
     * 
     * @return $this
     */
     ...
     * Set of redirect URLs you provide only for PayPal-based payments.
     *
     * @return \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\RedirectUrls
     */
