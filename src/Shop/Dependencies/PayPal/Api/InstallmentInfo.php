 ...
 * @property \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\InstallmentOption[] installment_options
 */
class InstallmentInfo extends PayPalModel
{
     ...
     *
     * @param \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\InstallmentOption[] $installment_options
     * 
     * @return $this
     */
     ...
     * List of available installment options and the cost associated with each one.
     *
     * @return \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\InstallmentOption[]
     */
     ...
     *
     * @param \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\InstallmentOption $installmentOption
     * @return $this
     */
