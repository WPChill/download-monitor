 ...
 * @property \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\FundingInstrument[] funding_instruments
 * @property string external_selected_funding_instrument_type
 * @property \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\PayerInfo payer_info
 */
class Payer extends PayPalModel
{
     ...
     *
     * @param \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\FundingInstrument[] $funding_instruments
     * 
     * @return $this
     */
     ...
     *
     * @param \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\FundingInstrument $fundingInstrument
     * @return $this
     */
     ...
     * @deprecated Not publicly available
     * @param \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\FundingOption $funding_option
     * 
     * @return $this
     */
     ...
     * Default funding option available for the payment 
     * @deprecated Not publicly available
     * @return \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\FundingOption
     */
     ...
     * @deprecated Not publicly available
     * @param \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\FundingOption $related_funding_option
     * 
     * @return $this
     */
     ...
     *
     * @param \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\PayerInfo $payer_info
     * 
     * @return $this
     */
     ...
     * Information related to the Payer. 
     *
     * @return \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\PayerInfo
     */
