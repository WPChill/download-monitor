 ...
 *
 * @property string id
 * @property \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\FundingSource[] funding_sources
 * @property \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\FundingInstrument backup_funding_instrument
 * @property \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\CurrencyConversion currency_conversion
 * @property \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\InstallmentInfo installment_info
...
class FundingOption extends PayPalModel
{
     ...
     *
     * @param \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\FundingSource[] $funding_sources
     * 
     * @return $this
     */
     ...
     * List of funding sources that contributes to a payment.
     *
     * @return \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\FundingSource[]
     */
     ...
     *
     * @param \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\FundingSource $fundingSource
     * @return $this
     */
     ...
     *
     * @param \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\FundingInstrument $backup_funding_instrument
     * 
     * @return $this
     */
     ...
     * Backup funding instrument which will be used for payment if primary fails.
     *
     * @return \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\FundingInstrument
     */
     ...
     *
     * @param \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\CurrencyConversion $currency_conversion
     * 
     * @return $this
     */
     ...
     * Currency conversion applicable to this funding option.
     *
     * @return \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\CurrencyConversion
     */
     ...
     *
     * @param \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\InstallmentInfo $installment_info
     * 
     * @return $this
     */
     ...
     * Installment options available for a funding option.
     *
     * @return \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\InstallmentInfo
     */
