 ...
 * @property \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\Amount amount
 ...
 * @property \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\Currency transaction_fee
 * @property \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\Currency receivable_amount
 * @property string exchange_rate
 * @property \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\FmfDetails fmf_details
 * @property string receipt_id
 * @property string parent_payment
 * @property \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\ProcessorResponse processor_response
...
class Sale extends PayPalResourceModel
{
     ...
     *
     * @param \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\Amount $amount
     * 
     * @return $this
     */
     ...
     * Amount being collected.
     *
     * @return \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\Amount
     */
     ...
     *
     * @param \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\Currency $transaction_fee
     * 
     * @return $this
     */
     ...
     *
     * @param \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\Currency $receivable_amount
     * 
     * @return $this
     */
     ...
     *
     * @param \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\FmfDetails $fmf_details
     * 
     * @return $this
     */
     ...
     * Fraud Management Filter (FMF) details applied for the payment that could result in accept, deny, or pending action. Returned in a payment response only if the merchant has enabled FMF in the profile settings and one of the fraud filters was triggered based on those settings. See [Fraud Management Filters Summary](/docs/classic/fmf/integration-guide/FMFSummary/) for more information.
     *
     * @return \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\FmfDetails
     */
     ...
     *
     * @param \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\ProcessorResponse $processor_response
     * 
     * @return $this
     */
     ...
     * Response codes returned by the processor concerning the submitted payment. Only supported when the `payment_method` is set to `credit_card`.
     *
     * @return \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\ProcessorResponse
     */
