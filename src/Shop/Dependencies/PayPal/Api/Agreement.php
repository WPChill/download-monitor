 ...
 * @property \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\Address shipping_address
 * @property \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\MerchantPreferences override_merchant_preferences
 * @property \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\OverrideChargeModel[] override_charge_models
 * @property \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\Plan plan
 * @property string create_time
 * @property string update_time
 * @property \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\AgreementDetails agreement_details
 */
class Agreement extends PayPalResourceModel
{
     ...
     *
     * @param \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\Address $shipping_address
     * 
     * @return $this
     */
     ...
     * Shipping address object of the agreement, which should be provided if it is different from the default address.
     *
     * @return \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\Address
     */
     ...
     *
     * @param \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\MerchantPreferences $override_merchant_preferences
     * 
     * @return $this
     */
     ...
     * Default merchant preferences from the billing plan are used, unless override preferences are provided here.
     *
     * @return \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\MerchantPreferences
     */
     ...
     *
     * @param \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\OverrideChargeModel[] $override_charge_models
     * 
     * @return $this
     */
     ...
     * Array of override_charge_model for this agreement if needed to change the default models from the billing plan.
     *
     * @return \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\OverrideChargeModel[]
     */
     ...
     *
     * @param \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\OverrideChargeModel $overrideChargeModel
     * @return $this
     */
     ...
     *
     * @param \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\Plan $plan
     * 
     * @return $this
     */
     ...
     * Plan details for this agreement.
     *
     * @return \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\Plan
     */
     ...
     * Agreement Details
     *
     * @param \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\AgreementDetails $agreement_details
     * 
     * @return $this
     */
     ...
     * Agreement Details
     *
     * @return \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\AgreementDetails
     */
