 ...
 *
 * @property \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\Currency total_cost
 * @property \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\number term
 * @property \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\Currency monthly_payment
 * @property \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\Currency total_interest
...
class CreditFinancingOffered extends PayPalModel
{
     ...
     *
     * @param \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\Currency $total_cost
     * 
     * @return $this
     */
     ...
     *
     * @param \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\number $term
     * 
     * @return $this
     */
     ...
     * Length of financing terms in month
     *
     * @return \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\number
     */
     ...
     *
     * @param \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\Currency $monthly_payment
     * 
     * @return $this
     */
     ...
     *
     * @param \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\Currency $total_interest
     * 
     * @return $this
     */
