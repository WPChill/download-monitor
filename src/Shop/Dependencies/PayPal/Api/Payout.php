 ...
 *
 * @property \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\PayoutSenderBatchHeader sender_batch_header
 * @property \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\PayoutItem[] items
...
class Payout extends PayPalResourceModel
{
     ...
     *
     * @param \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\PayoutSenderBatchHeader $sender_batch_header
     *
     * @return $this
     */
     ...
     * The original batch header as provided by the payment sender.
     *
     * @return \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\PayoutSenderBatchHeader
     */
     ...
     *
     * @param \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\PayoutItem[] $items
     *
     * @return $this
     */
     ...
     * An array of payout items (that is, a set of individual payouts).
     *
     * @return \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\PayoutItem[]
     */
     ...
     *
     * @param \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\PayoutItem $payoutItem
     * @return $this
     */
