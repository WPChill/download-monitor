 ...
 * @property \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\Invoice[] invoices
 */
class InvoiceSearchResponse extends PayPalModel
{
     ...
     *
     * @param \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\Invoice[] $invoices
     * 
     * @return $this
     */
     ...
     * List of invoices belonging to a merchant.
     *
     * @return \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\Invoice[]
     */
     ...
     *
     * @param \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\Invoice $invoice
     * @return $this
     */
