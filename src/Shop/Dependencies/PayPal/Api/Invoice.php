...
use Never5\DownloadMonitor\Shop\Dependencies\PayPal\Common\PayPalResourceModel;
use Never5\DownloadMonitor\Shop\Dependencies\PayPal\Rest\ApiContext;
use Never5\DownloadMonitor\Shop\Dependencies\PayPal\Transport\PayPalRestCall;
use Never5\DownloadMonitor\Shop\Dependencies\PayPal\Validation\ArgumentValidator;
use Never5\DownloadMonitor\Shop\Dependencies\PayPal\Validation\UrlValidator;
 ...
 * @property \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\MerchantInfo merchant_info
 * @property \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\BillingInfo[] billing_info
 * @property \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\Participant[] cc_info
 * @property \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\ShippingInfo shipping_info
 * @property \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\InvoiceItem[] items
 * @property string invoice_date
 * @property \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\PaymentTerm payment_term
 * @property string reference
 * @property \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\Cost discount
 * @property \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\ShippingCost shipping_cost
 * @property \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\CustomAmount custom
 * @property bool allow_partial_payment
 * @property \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\Currency minimum_amount_due
 ...
 * @property \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\Currency total_amount
 * @property \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\PaymentDetail[] payments
 * @property \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\RefundDetail[] refunds
 * @property \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\Metadata metadata
 * @property \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\PaymentSummary paid_amount
 * @property \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\PaymentSummary refunded_amount
 * @property \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\FileAttachment[] attachments
 */
class Invoice extends PayPalResourceModel
{
     ...
     *
     * @param \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\MerchantInfo $merchant_info
     * 
     * @return $this
     */
     ...
     * Information about the merchant who is sending the invoice.
     *
     * @return \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\MerchantInfo
     */
     ...
     *
     * @param \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\BillingInfo[] $billing_info
     * 
     * @return $this
     */
     ...
     * The required invoice recipient email address and any optional billing information. One recipient is supported.
     *
     * @return \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\BillingInfo[]
     */
     ...
     *
     * @param \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\BillingInfo $billingInfo
     * @return $this
     */
     ...
     *
     * @param \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\Participant[] $cc_info
     * 
     * @return $this
     */
     ...
     * For invoices sent by email, one or more email addresses to which to send a Cc: copy of the notification. Supports only email addresses under participant.
     *
     * @return \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\Participant[]
     */
     ...
     *
     * @param \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\Participant $participant
     * @return $this
     */
     ...
     *
     * @param \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\ShippingInfo $shipping_info
     * 
     * @return $this
     */
     ...
     * The shipping information for entities to whom items are being shipped.
     *
     * @return \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\ShippingInfo
     */
     ...
     *
     * @param \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\InvoiceItem[] $items
     * 
     * @return $this
     */
     ...
     * The list of items to include in the invoice. Maximum value is 100 items per invoice.
     *
     * @return \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\InvoiceItem[]
     */
     ...
     *
     * @param \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\InvoiceItem $invoiceItem
     * @return $this
     */
     ...
     *
     * @param \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\PaymentTerm $payment_term
     * 
     * @return $this
     */
     ...
     * Optional. The payment deadline for the invoice. Value is either `term_type` or `due_date` but not both.
     *
     * @return \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\PaymentTerm
     */
     ...
     *
     * @param \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\Cost $discount
     * 
     * @return $this
     */
     ...
     * The invoice level discount, as a percent or an amount value.
     *
     * @return \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\Cost
     */
     ...
     *
     * @param \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\ShippingCost $shipping_cost
     * 
     * @return $this
     */
     ...
     * The shipping cost, as a percent or an amount value.
     *
     * @return \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\ShippingCost
     */
     ...
     *
     * @param \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\CustomAmount $custom
     * 
     * @return $this
     */
     ...
     * The custom amount to apply on an invoice. If you include a label, the amount cannot be empty.
     *
     * @return \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\CustomAmount
     */
     ...
     *
     * @param \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\Currency $minimum_amount_due
     * 
     * @return $this
     */
     ...
     * If `allow_partial_payment` is set to `true`, the minimum amount allowed for a partial payment.
     *
     * @return \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\Currency
     */
     ...
     *
     * @param \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\Currency $total_amount
     * 
     * @return $this
     */
     ...
     *
     * @param \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\PaymentDetail[] $payments
     * 
     * @return $this
     */
     ...
     * List of payment details for the invoice.
     *
     * @return \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\PaymentDetail[]
     */
     ...
     *
     * @param \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\PaymentDetail $paymentDetail
     * @return $this
     */
     ...
     *
     * @param \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\RefundDetail[] $refunds
     * 
     * @return $this
     */
     ...
     * List of refund details for the invoice.
     *
     * @return \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\RefundDetail[]
     */
     ...
     *
     * @param \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\RefundDetail $refundDetail
     * @return $this
     */
     ...
     *
     * @param \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\Metadata $metadata
     * 
     * @return $this
     */
     ...
     * Audit information for the invoice.
     *
     * @return \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\Metadata
     */
     ...
     *
     * @param \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\PaymentSummary $paid_amount
     * 
     * @return $this
     */
     ...
     * Payment summary of the invoice including amount paid through PayPal and other sources.
     *
     * @return \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\PaymentSummary
     */
     ...
     *
     * @param \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\PaymentSummary $refunded_amount
     * 
     * @return $this
     */
     ...
     *
     * @param \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\FileAttachment[] $attachments
     * 
     * @return $this
     */
     ...
     * List of files attached to the invoice.
     *
     * @return \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\FileAttachment[]
     */
     ...
     *
     * @param \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Api\FileAttachment $fileAttachment
     * @return $this
     */
