...
namespace Never5\DownloadMonitor\Shop\Dependencies\PayPal\Auth;

use Never5\DownloadMonitor\Shop\Dependencies\PayPal\Cache\AuthorizationCache;
use Never5\DownloadMonitor\Shop\Dependencies\PayPal\Common\PayPalResourceModel;
use Never5\DownloadMonitor\Shop\Dependencies\PayPal\Core\PayPalHttpConfig;
use Never5\DownloadMonitor\Shop\Dependencies\PayPal\Core\PayPalHttpConnection;
use Never5\DownloadMonitor\Shop\Dependencies\PayPal\Core\PayPalLoggingManager;
use Never5\DownloadMonitor\Shop\Dependencies\PayPal\Exception\PayPalConfigurationException;
use Never5\DownloadMonitor\Shop\Dependencies\PayPal\Exception\PayPalConnectionException;
use Never5\DownloadMonitor\Shop\Dependencies\PayPal\Handler\IPayPalHandler;
use Never5\DownloadMonitor\Shop\Dependencies\PayPal\Rest\ApiContext;
use Never5\DownloadMonitor\Shop\Dependencies\PayPal\Security\Cipher;
...
class OAuthTokenCredential extends PayPalResourceModel
{
     ...
     */
    public static $AUTH_HANDLER = 'Never5\DownloadMonitor\Shop\Dependencies\PayPal\Handler\OauthHandler';
     ...
     * @throws \Never5\DownloadMonitor\Shop\Dependencies\PayPal\Exception\PayPalConnectionException
     */
