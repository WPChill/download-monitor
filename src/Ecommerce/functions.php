 ...
 *
 * @param int $price
 * @param array $args (see \Never5\DownloadMonitor\Ecommerce\Helper\Format)
 *
 * @return string
 */
function dlm_format_money( $price, $args=array() ) {
	return \Never5\DownloadMonitor\Ecommerce\Services\Services::get()->service( 'format' )->money( $price, $args );
}
