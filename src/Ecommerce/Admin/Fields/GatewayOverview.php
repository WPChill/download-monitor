...
namespace Never5\DownloadMonitor\Ecommerce\Admin\Fields;

class GatewayOverview extends \DLM_Admin_Fields_Field {

	/** @var \Never5\DownloadMonitor\Ecommerce\Checkout\PaymentGateway\PaymentGateway[] */
	private $gateways;

	/**
	 * GatewayOverview constructor.
	 *
	 * @param \Never5\DownloadMonitor\Ecommerce\Checkout\PaymentGateway\PaymentGateway[] $gateways
	 */
