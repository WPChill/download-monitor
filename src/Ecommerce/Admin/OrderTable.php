...
class OrderTable extends \WP_List_Table {
	...
	public function display_tablenav( $which ) {
		...
		if ( 'top' == $which ) {
            ...
            <ul class="subsubsub">
				...
				/** @var \Never5\DownloadMonitor\Ecommerce\Order\WordPressRepository $order_repo */
				$order_repo = Services::get()->service( 'order_repository' );
				$statuses   = Services::get()->service( 'order_status' )->get_available_statuses();
				/** @var \Never5\DownloadMonitor\Ecommerce\Order\Status\OrderStatus $status */
	...
	public function prepare_items() {
		...
		*/
		...
		/** @var \Never5\DownloadMonitor\Ecommerce\Order\WordPressRepository $order_repository */
