 ...
 *
 * @property \Never5\DownloadMonitor\Ecommerce\Dependencies\PayPal\Api\BankAccount[] bank_accounts
 * @property int count
...
class BankAccountsList extends PayPalModel
{
     ...
     * A list of bank account resources
     *
     * @param \Never5\DownloadMonitor\Ecommerce\Dependencies\PayPal\Api\BankAccount[] $bank_accounts
     * 
     * @return $this
     */
     ...
     * A list of bank account resources
     *
     * @return \Never5\DownloadMonitor\Ecommerce\Dependencies\PayPal\Api\BankAccount[]
     */
     ...
     *
     * @param \Never5\DownloadMonitor\Ecommerce\Dependencies\PayPal\Api\BankAccount $bankAccount
     * @return $this
     */
