...
use Never5\DownloadMonitor\Ecommerce\Dependencies\PayPal\Converter\FormatConverter;
use Never5\DownloadMonitor\Ecommerce\Dependencies\PayPal\Validation\NumericValidator;
...
class Item extends PayPalModel
{
     ...
     * Weight of the item.
     * @deprecated Not publicly available
     * @param \Never5\DownloadMonitor\Ecommerce\Dependencies\PayPal\Api\Measurement $weight
     * 
     * @return $this
     */
     ...
     * Weight of the item.
     * @deprecated Not publicly available
     * @return \Never5\DownloadMonitor\Ecommerce\Dependencies\PayPal\Api\Measurement
     */
     ...
     * Length of the item.
     * @deprecated Not publicly available
     * @param \Never5\DownloadMonitor\Ecommerce\Dependencies\PayPal\Api\Measurement $length
     * 
     * @return $this
     */
     ...
     * Height of the item.
     * @deprecated Not publicly available
     * @param \Never5\DownloadMonitor\Ecommerce\Dependencies\PayPal\Api\Measurement $height
     * 
     * @return $this
     */
     ...
     * Width of the item.
     * @deprecated Not publicly available
     * @param \Never5\DownloadMonitor\Ecommerce\Dependencies\PayPal\Api\Measurement $width
     * 
     * @return $this
     */
     ...
     * @deprecated Not publicly available
     * @param \Never5\DownloadMonitor\Ecommerce\Dependencies\PayPal\Api\NameValuePair[] $supplementary_data
     * 
     * @return $this
     */
     ...
     * Set of optional data used for PayPal risk determination.
     * @deprecated Not publicly available
     * @return \Never5\DownloadMonitor\Ecommerce\Dependencies\PayPal\Api\NameValuePair[]
     */
     ...
     * @deprecated Not publicly available
     * @param \Never5\DownloadMonitor\Ecommerce\Dependencies\PayPal\Api\NameValuePair $nameValuePair
     * @return $this
     */
     ...
     * @deprecated Not publicly available
     * @param \Never5\DownloadMonitor\Ecommerce\Dependencies\PayPal\Api\NameValuePair[] $postback_data
     * 
     * @return $this
     */
