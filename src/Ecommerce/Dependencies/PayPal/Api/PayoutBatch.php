 ...
 *
 * @property \Never5\DownloadMonitor\Ecommerce\Dependencies\PayPal\Api\PayoutBatchHeader batch_header
 * @property \Never5\DownloadMonitor\Ecommerce\Dependencies\PayPal\Api\PayoutItemDetails[] items
...
class PayoutBatch extends PayPalModel
{
     ...
     *
     * @param \Never5\DownloadMonitor\Ecommerce\Dependencies\PayPal\Api\PayoutBatchHeader $batch_header
     * 
     * @return $this
     */
     ...
     * A batch header. Includes the generated batch status.
     *
     * @return \Never5\DownloadMonitor\Ecommerce\Dependencies\PayPal\Api\PayoutBatchHeader
     */
     ...
     *
     * @param \Never5\DownloadMonitor\Ecommerce\Dependencies\PayPal\Api\PayoutItemDetails[] $items
     * 
     * @return $this
     */
     ...
     * An array of items in a batch payout.
     *
     * @return \Never5\DownloadMonitor\Ecommerce\Dependencies\PayPal\Api\PayoutItemDetails[]
     */
     ...
     *
     * @param \Never5\DownloadMonitor\Ecommerce\Dependencies\PayPal\Api\PayoutItemDetails $payoutItemDetails
     * @return $this
     */
