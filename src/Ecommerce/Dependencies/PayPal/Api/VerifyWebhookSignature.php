...
use Never5\DownloadMonitor\Ecommerce\Dependencies\PayPal\Api\VerifyWebhookSignatureResponse;
 ...
 * @property \Never5\DownloadMonitor\Ecommerce\Dependencies\PayPal\Api\WebhookEvent webhook_event
 */
class VerifyWebhookSignature extends PayPalResourceModel
{
     ...
     * @param \Never5\DownloadMonitor\Ecommerce\Dependencies\PayPal\Api\WebhookEvent $webhook_event
     *
     * @return $this
     */
     ...
     * The webhook notification, which is the content of the HTTP `POST` request body.
     *
     * @return \Never5\DownloadMonitor\Ecommerce\Dependencies\PayPal\Api\WebhookEvent
     */
