 ...
 *
 * @property \Never5\DownloadMonitor\Ecommerce\Dependencies\PayPal\Api\Webhook[] webhooks
 */
class WebhookList extends PayPalModel
{
     ...
     * A list of webhooks.
     *
     * @param \Never5\DownloadMonitor\Ecommerce\Dependencies\PayPal\Api\Webhook[] $webhooks
     * 
     * @return $this
     */
     ...
     * A list of webhooks.
     *
     * @return \Never5\DownloadMonitor\Ecommerce\Dependencies\PayPal\Api\Webhook[]
     */
     ...
     *
     * @param \Never5\DownloadMonitor\Ecommerce\Dependencies\PayPal\Api\Webhook $webhook
     * @return $this
     */
