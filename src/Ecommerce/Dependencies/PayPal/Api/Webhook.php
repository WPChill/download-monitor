...
use Never5\DownloadMonitor\Ecommerce\Dependencies\PayPal\Api\WebhookList;
 ...
 * @property string id
 * @property string url
 * @property \Never5\DownloadMonitor\Ecommerce\Dependencies\PayPal\Api\WebhookEventType[] event_types
 */
class Webhook extends PayPalResourceModel
{
     ...
     *
     * @param \Never5\DownloadMonitor\Ecommerce\Dependencies\PayPal\Api\WebhookEventType[] $event_types
     * 
     * @return $this
     */
     ...
     * A list of up to ten events to which to subscribe your webhook. To subscribe to all events including new events as they are added, specify the asterisk (`*`) wildcard. To replace the `event_types` array, specify the `*` wildcard. To see all supported events, [list available events](#available-event-type.list).
     *
     * @return \Never5\DownloadMonitor\Ecommerce\Dependencies\PayPal\Api\WebhookEventType[]
     */
     ...
     *
     * @param \Never5\DownloadMonitor\Ecommerce\Dependencies\PayPal\Api\WebhookEventType $webhookEventType
     * @return $this
     */
