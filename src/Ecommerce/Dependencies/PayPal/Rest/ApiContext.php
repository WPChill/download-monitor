...
namespace Never5\DownloadMonitor\Ecommerce\Dependencies\PayPal\Rest;

use Never5\DownloadMonitor\Ecommerce\Dependencies\PayPal\Core\PayPalConfigManager;
 ...
 *
 * @package Never5\DownloadMonitor\Ecommerce\Dependencies\PayPal\Rest
 */
class ApiContext
{
     ...
     * If the value is not set, it would get the value from @\Never5\DownloadMonitor\Ecommerce\Dependencies\PayPal\Core\PayPalCredentialManager
     *
     * @var \Never5\DownloadMonitor\Ecommerce\Dependencies\PayPal\Auth\OAuthTokenCredential
     */
    private $credential;
     ...
     * Construct
     *
     * @param \Never5\DownloadMonitor\Ecommerce\Dependencies\PayPal\Auth\OAuthTokenCredential $credential
     ...
     * Get Credential
     *
     * @return \Never5\DownloadMonitor\Ecommerce\Dependencies\PayPal\Auth\OAuthTokenCredential
     */
