...
namespace Never5\DownloadMonitor\Ecommerce\Dependencies\PayPal\Handler;

use Never5\DownloadMonitor\Ecommerce\Dependencies\PayPal\Auth\OAuthTokenCredential;
use Never5\DownloadMonitor\Ecommerce\Dependencies\PayPal\Common\PayPalUserAgent;
use Never5\DownloadMonitor\Ecommerce\Dependencies\PayPal\Core\PayPalConstants;
use Never5\DownloadMonitor\Ecommerce\Dependencies\PayPal\Core\PayPalCredentialManager;
...
use Never5\DownloadMonitor\Ecommerce\Dependencies\PayPal\Exception\PayPalInvalidCredentialException;
use Never5\DownloadMonitor\Ecommerce\Dependencies\PayPal\Exception\PayPalMissingCredentialException;
...
class RestHandler implements IPayPalHandler
{
     ...
     *
     * @return string
     * @throws \Never5\DownloadMonitor\Ecommerce\Dependencies\PayPal\Exception\PayPalConfigurationException
     */
