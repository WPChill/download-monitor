...
<a data-e-Disable-Page-Transition="true" class="aligncenter download-button<?php echo ( ! empty( $dlm_attributes['className'] ) ) ? ' ' . esc_attr( $dlm_attributes['className'] ) : '' ; ?>" href="<?php $dlm_download->the_download_link(); ?>" rel="nofollow">
	<p>
