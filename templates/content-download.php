...
?>
<a data-e-Disable-Page-Transition="true" exclude="<?php $dlm_download->the_download_link(); ?>" class="download-link<?php echo ( ! empty( $dlm_attributes['className'] ) ) ? ' ' . esc_attr( $dlm_attributes['className'] ) : '' ; ?>" title="
<?php
